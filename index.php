...
<body data-theme="light">
  ...
  <div class="grid" id="projectList">
    <?php
      ...
      foreach ($dirs as $dir) {
          if (in_array($dir, $excluded)) continue;
          echo "<a href='/$dir' class='card' data-name='$dir'>
                  <h2>" . ucfirst($dir) . "</h2>
  ...
  <footer>
    ...
    <div class="icons">
      ...
      <a href="https://gitlab.com/sajadmirave" target="_blank" title="GitLab">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M22.54 13.88l-2.01-6.2a.753.753 0 0 0-1.43-.02l-1.71 5.25H6.61l-1.7-5.25a.75.75 0 0 0-1.43.02l-2 6.2c-.27.82.02 1.73.72 2.25l8.73 6.28c.52.38 1.24.38 1.76 0l8.72-6.28c.7-.52 1-1.43.73-2.25z"/></svg>
      </a>
    </div>
  </footer>
